...
import { ArbolBinario, HandlerCambioEstado, HandlerNeedPlanAccion, HandlerNeedValidacion, HandlerProblemas, HandlerTrue,  } from "../src/core/caseUse/builder";
import { documentoConProblemas } from "../src/functions/test2";
